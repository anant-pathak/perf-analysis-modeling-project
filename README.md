...
- Note: llama.cpp is built with Qwen 3: https://huggingface.co/Qwen/Qwen3-8B-GGUF
  Other quantized Qwen3 models used: https://huggingface.co/Qwen/Qwen3-0.6B-GGUF & https://huggingface.co/Qwen/Qwen3-4B-GGUF
